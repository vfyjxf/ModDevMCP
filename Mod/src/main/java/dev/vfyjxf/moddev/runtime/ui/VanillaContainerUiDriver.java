...
public final class VanillaContainerUiDriver extends VanillaScreenUiDriver {
    ...
    @Override
    public dev.vfyjxf.moddev.api.model.OperationResult<TooltipSnapshot> tooltip(UiContext context, TargetSelector selector) {
        ...
        return dev.vfyjxf.moddev.api.model.OperationResult.success(new TooltipSnapshot(
                target.targetId(),
                lines,
                target.bounds(),
