...
import dev.vfyjxf.moddev.server.transport.GsonMcpJsonMapper;
import dev.vfyjxf.moddev.server.transport.McpServerTransport;
import dev.vfyjxf.moddev.server.transport.PermissiveJsonSchemaValidator;
...
public final class ModDevMcpServerFactory {
    ...
    private static McpSchema.Tool toSdkToolDefinition(dev.vfyjxf.moddev.server.api.McpToolDefinition definition) {
    ...
    private static McpSchema.ToolAnnotations toToolAnnotations(dev.vfyjxf.moddev.server.api.McpToolDefinition definition) {
    ...
    private static Map<String, Object> toToolMeta(dev.vfyjxf.moddev.server.api.McpToolDefinition definition) {
