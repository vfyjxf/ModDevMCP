...
class InputToolProviderTest {
    ...
    void inputActionReturnsFailureWhenNoControllerAcceptsAction() {
        ...
        assertEquals("unsupported: no input controller accepted action click (dev.vfyjxf.moddev.runtime.tool.InputToolProviderTest$RecordingInputController: unsupported)", result.error());
    }
