...
import dev.vfyjxf.moddev.runtime.world.WorldCreateResult;
import dev.vfyjxf.moddev.runtime.world.WorldDescriptor;
import dev.vfyjxf.moddev.runtime.world.WorldJoinRequest;
import dev.vfyjxf.moddev.runtime.world.WorldJoinResult;
import dev.vfyjxf.moddev.runtime.world.WorldListResult;
...
class WorldToolProviderTest {
    ...
    void worldCreateDefaultsJoinAfterCreateToTrue() {
        ...
        var result = server.registry().findTool("moddev.world_create").orElseThrow()
                .handler()
                .handle(new dev.vfyjxf.moddev.server.api.ToolCallContext("client", Map.of("runtimeId", "client-runtime")), Map.of("name", "Test World"));
    ...
    void worldJoinPrefersIdOverName() {
        ...
        var result = server.registry().findTool("moddev.world_join").orElseThrow()
                .handler()
                .handle(new dev.vfyjxf.moddev.server.api.ToolCallContext("client", Map.of("runtimeId", "client-runtime")),
